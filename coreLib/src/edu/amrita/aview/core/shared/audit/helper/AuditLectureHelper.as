...
package edu.amrita.aview.core.shared.audit.helper
{
	...
	public class AuditLectureHelper extends AbstractHelper
	{
		...
		public function AuditLectureHelper()
		{
			...
			auditLectureRO.getAuditLectureByLectureId.addEventListener("result", getAuditLectureByLectureIdResultHandler);
			auditLectureRO.getAuditLectureByLectureId.addEventListener("fault", genericFaultHandler);
		}
		...
		public function getAuditLectureByLectureId(lectureId:Number,onResult:Function,onFault:Function = null):void
		{
			var token:AsyncToken=auditLectureRO.getAuditLectureByLectureId(lectureId);
			token.onResult=onResult;
			token.onFault=onFault;
		}
		private function getAuditLectureByLectureIdResultHandler(event:ResultEvent):void
		{

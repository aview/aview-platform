...
package edu.amrita.aview.core.shared.audit
{
	...
	import edu.amrita.aview.core.shared.audit.helper.UserActionHelper;
	...
	public class AuditUserAction
	{
		...
		{
			//Fix for Bug #18008
			if(AuditContext.actionsHash && AuditContext.actionsHash[actionName])
			{
				var actionId:int = AuditContext.actionsHash[actionName];
				if (ClassroomContext.aviewClass == null || ClassroomContext.aviewClass.classId == 0 ||  ClassroomContext.aviewClass.auditLevel == Constants.AUDIT_ACTION_LEVEL)
				{

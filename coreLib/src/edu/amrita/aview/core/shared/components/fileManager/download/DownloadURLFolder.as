				...
				if (usingModule == FileManager.MODULE_2D_SHARING)
				{
					...
					applicationType::web
					{
						...
						else
						{
							...
							//PNCR: Seems onDownload is not a valid function. 
							FlexGlobals.topLevelApplication.mainApp.mainContainerComp.classroomComp.viewer2DComp.onDownLoad(downDetails.localpath, downloadFile.fileName, remoteFolderURL.slice(remoteFolderURL.indexOf("/AVContent"), -1));
						}
					}
				}
				applicationType::web

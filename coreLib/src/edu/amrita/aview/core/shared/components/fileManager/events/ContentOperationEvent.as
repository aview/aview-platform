...
package edu.amrita.aview.core.shared.components.fileManager.events
{
	...
	public class ContentOperationEvent extends Event
	{
		...
		public static const IS_ANIMATION:String="isAnimation";
		...
		private var _isAnimatedFile:String="N";
		/**
		...
		/**
		 * For store Animated File
		 */
		public function get isAnimatedFile():String
		{
			return _isAnimatedFile;
		}

		/**
		 * @private
		 */
		public function set isAnimatedFile(value:String):void
		{
			_isAnimatedFile= value;
		}

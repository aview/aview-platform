...
private function startUpload():void
{
	...
	else if (fileReference != null && fileReference.size > 104857600)
	{
		MessageBox.show("File more than 100MB in size cannot be uploaded!", "WARNING", MessageBox.MB_OK, this, null, null, MessageBox.IC_INFO);
	}
	else
	{
...
{  
	var iSpringCheck:Boolean=ClassroomContext.contentServerSupportsAnimations;
	if((fileExtention=="ppt" || fileExtention=="pptx" || fileExtention=="pptm"|| fileExtention=="pps")&& iSpringCheck)
	{
		//Alert.show("Do you want to keep the animations in the uploaded file?","Information",Alert.YES|Alert.NO,this,confirmAnimationFile,null,Alert.NO);
		alert=MessageBox.show("The selected file may have animations and its upload can be time consuming.Do you want to upload the file preserving the animations (if any)?", "Confirmation", MessageBox.MB_YESNO, this,confirmAnimationFile,notConfirmAnimationFile);
...
/**
 * @private 
 * @param confirm Animation
 * 
 */
private function confirmAnimationFile(evnt:MessageBoxEvent):void
{
...
private function notConfirmAnimationFile(event:MessageBoxEvent):void
{
	
	confirmUploadFile();
	
}
private function confirmUploadFile():void
{

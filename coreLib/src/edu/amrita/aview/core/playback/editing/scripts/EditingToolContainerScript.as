...
import edu.amrita.aview.core.playback.editing.components.Ribbon;
import edu.amrita.aview.core.playback.editing.components.RibbonTitle;
import edu.amrita.aview.core.playback.editing.components.Scale;
...
[Bindable]
[Embed(source="/edu/amrita/aview/core/playback/editing/assets/images/videoUnselect.png")]
private var pVideoIcon:Class;

[Bindable]
[Embed(source="/edu/amrita/aview/core/playback/editing/assets/images/viewerVideo.png")]
private var vVideoIcon:Class;

[Bindable]
[Embed(source="/edu/amrita/aview/core/playback/editing/assets/images/docUnselect.png")]
private var documentIcon:Class;

[Bindable]
[Embed(source="/edu/amrita/aview/core/playback/editing/assets/images/whiteboardUnselect.png")]
private var whiteboardIcon:Class;

[Bindable]
[Embed(source="/edu/amrita/aview/core/playback/editing/assets/images/chatUnselect.png")]
...
public function drawPresenterVideoRibbon():void{
	...
	addRibbonTitle(yPosition, pVideoIcon, "Presenter Video");
...
private function drawViewerVideoRibbon():void{
	...
	addRibbonTitle(yPosition, vVideoIcon , "Viewer Video");
...
private function drawDocumentSharingRibbon():void{
	...
	addRibbonTitle(yPosition, documentIcon , "Document");
...
private function drawWBRibbon():void{
	...
	addRibbonTitle(yPosition, whiteboardIcon, "Whiteboard");
...
private function drawChatRibbon():void{
	...
	addRibbonTitle(yPosition, chatIcon, "Chat");
	if (chatRibbon == null){
 ...
 *
 */
private function addRibbonTitle(yPosition:int, imageSource:Class, description:String):void{
	...
	ribbonTitle.imageSource=imageSource;

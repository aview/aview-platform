...
import edu.amrita.aview.core.playback.editing.components.EditLecture;
import edu.amrita.aview.core.playback.editing.components.InsertLectureTime;
import edu.amrita.aview.core.playback.editing.components.VideoRecordComponent;
import edu.amrita.aview.core.playback.editing.scripts.CloseFileHandler;
import edu.amrita.aview.core.playback.editing.skins.SliderThumbSkin;
...
private function videoEditingClose(event:CloseFileHandler):void{
	applicationType::desktop{
		...
		FlexGlobals.topLevelApplication.mainApp.mainContainerComp.lmsInst.videoEditor.close();
	}

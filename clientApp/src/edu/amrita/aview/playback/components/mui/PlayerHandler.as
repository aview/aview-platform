...
import edu.amrita.aview.playback.components.mui.DesktopSharing;
import edu.amrita.aview.playback.components.mui.VideoPanel;
...
private function createWbComp():void
{
	...
	wbCan.addElement(wbPlayer.whiteBoardSprite);
...
private function onResizeWb(evt:ResizeEvent):void
{
	if( wbPlayer && wbPlayer.whiteBoardSprite)
	{
		...
		wbCan.removeElement(wbPlayer.whiteBoardSprite);
		whiteboardMask=null;
		wbPlayer.whiteBoardSprite.width=Can.width	;
		wbPlayer.whiteBoardSprite.height=Can.height;
		wbPlayer.whiteBoardSprite.drawBackground(0xffffff);
		wbCan.addElement(wbPlayer.whiteBoardSprite);
		whiteboardMask=new Canvas()
		whiteboardMask.graphics.beginFill(0xffffff,1);

package edu.amrita.aview.playback.oldPlayback.fxcomponents.controls
{
	import edu.amrita.aview.playback.oldPlayback.fxcomponents.controls.fxslider.FXSliderThumb;
	import edu.amrita.aview.playback.oldPlayback.fxcomponents.skins.SliderThumbSkin;
	import edu.amrita.aview.playback.oldPlayback.fxcomponents.skins.SliderTrackSkin;
	...
	public class FXSlider extends UIComponent
	{
		...
		override protected function createChildren():void
		{
			...
			if (!thumbSkin)
				thumbSkin=edu.amrita.aview.playback.oldPlayback.fxcomponents.skins.SliderThumbSkin;
			
			trackSkin=getStyle("trackSkin");
			if (!trackSkin)
				trackSkin=edu.amrita.aview.playback.oldPlayback.fxcomponents.skins.SliderTrackSkin;
			
			trackHighlightSkin=getStyle("trackHighlightSkin");
			if (!trackHighlightSkin)
				trackHighlightSkin=edu.amrita.aview.playback.oldPlayback.fxcomponents.skins.SliderHighlightSkin;

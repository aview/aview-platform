		...
		public function launchInternalCodecMultipleBitrateEXE(val:uint, attachCamera:Boolean):void
		{
			...
			applicationType::desktop
			{
				...
				if (val == 2)
				{
					...
					file=file.resolvePath("edu/amrita/aview/video/native/Windows/bin/InternalCodecMultipleBitrateSlaveEXE/MulitBitRateStreamer.exe");
				}
				else
				{
					file=file.resolvePath("edu/amrita/aview/video/native/Windows/bin/InternalCodecMultipleBitrateSlaveEXE2/MulitBitRateStreamer.exe");
				}

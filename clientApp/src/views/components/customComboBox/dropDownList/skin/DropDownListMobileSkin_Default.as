...
//
////////////////////////////////////////////////////////////////////////////////
package views.components.customComboBox.dropDownList.skin
{
	import views.components.customComboBox.autoCompleteComboBox.skins.DownArrowSkin_Default;
	...
	public class DropDownListMobileSkin_Default extends MobileSkin
	{
		...
		private static function classConstruct():Boolean {
			if (!FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("components.customComboBox.dropDownList.skin.DropDownListMobileSkin_Default"))
			{
				...
				myStyle.setStyle('requestedRowCount',3);
				
				FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("components.customComboBox.dropDownList.skin.DropDownListMobileSkin_Default", myStyle, true);
...
//			this.setElementSize(this.labelDisplay,unscaledWidth-downArrowHeight- this.separationLine.width -1-1,unscaledHeight );
			...
			if(this.popUp){
				...
				if(firstRenderer){
					...
					this.popUp.height = 1;//popUpHeight;

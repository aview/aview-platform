...
//
////////////////////////////////////////////////////////////////////////////////
package views.components.customComboBox.dropDownList
{
	...
	import views.components.customComboBox.dropDownList.skin.DropDownListMobileSkin_Default;
	...
	public class DropDownList extends spark.components.DropDownList
	{
		...
		private static function classConstruct():Boolean {
			if (FlexGlobals.topLevelApplication!= null && !FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("views.components.customComboBox.dropDownList.DropDownList"))
			{
				...
				myStyle.setStyle('skinClass',DropDownListMobileSkin_Default);
				// used for the drop down in the mobile skin 
				myStyle.setStyle('requestedRowCount',2);
				
				FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("views.components.customComboBox.dropDownList.DropDownList", myStyle, true);

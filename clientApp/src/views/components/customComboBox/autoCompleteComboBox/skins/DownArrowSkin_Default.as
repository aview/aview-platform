...
//
////////////////////////////////////////////////////////////////////////////////
package views.components.customComboBox.autoCompleteComboBox.skins
{
	import flash.display.DisplayObject;
	import flash.events.Event;
	
	import views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile160.DownArrow_down_default;
	import views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile160.DownArrow_up_default;
	import views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile240.DownArrow_down_default;
	import views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile240.DownArrow_up_default;
	import views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile320.DownArrow_down_default;
	import views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile320.DownArrow_up_default;
	...
	public class DownArrowSkin_Default extends ButtonSkin
	{
		public function DownArrowSkin_Default()
		{
			...
			switch (applicationDPI)
			{
				...
				{
					downArrowDownSkin = views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile320.DownArrow_down_default;
					downArrowUpSkin = views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile320.DownArrow_up_default;
					
					break;
				}
				case DPIClassification.DPI_240:
				{
					downArrowDownSkin = views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile240.DownArrow_down_default;
					downArrowUpSkin = views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile240.DownArrow_up_default;
				...
				{
					// default DPI_160
					downArrowDownSkin = views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile160.DownArrow_down_default;
					downArrowUpSkin = views.components.customComboBox.autoCompleteComboBox.skins.assets.mobile160.DownArrow_up_default;

...
package views.components.customComboBox.autoCompleteComboBox.skins
{
	...
	import views.components.customComboBox.autoCompleteComboBox.AutoCompleteCollectionEvent;
	import views.components.customComboBox.autoCompleteComboBox.AutoCompleteComboBoxMobile;
	...
	public class AutoCompleteComboBoxMobileSkin_Default extends MobileSkin
	{
		...
		private static function classConstruct():Boolean {
			if (!FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("views.components.customComboBox.autoCompleteComboBox.skins.AutoCompleteComboBoxMobileSkin_Default"))
			{
				...
				FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("views.components.customComboBox.autoCompleteComboBox.skins.AutoCompleteComboBoxMobileSkin_Default", myStyle, true);
		 ...
		 */
		protected var openButtonSkin : Class = views.components.customComboBox.autoCompleteComboBox.skins.DownArrowSkin_Default;										

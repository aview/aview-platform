...
{
	import views.components.customComboBox.autoCompleteComboBox.renderers.DefaultAutoCompleteRenderer;
	import views.components.customComboBox.autoCompleteComboBox.skins.AutoCompleteComboBoxMobileSkin_Default;
	...
	{ 
		...
		{
			super();
			itemRenderer = new ClassFactory(views.components.customComboBox.autoCompleteComboBox.renderers.DefaultAutoCompleteRenderer);
		}
		...
		private static function classConstruct():Boolean {
			if (!FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("views.components.customComboBox.autoCompleteComboBox.AutoCompleteComboBoxMobile"))
			{
				...
				myStyle.setStyle('skinClass',AutoCompleteComboBoxMobileSkin_Default);
				// used for the drop down in the mobile skin 
				myStyle.setStyle('requestedRowCount',4);
				
				FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("views.components.customComboBox.autoCompleteComboBox.AutoCompleteComboBoxMobile", myStyle, true);
